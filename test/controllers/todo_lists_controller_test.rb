...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { completed: @todo_list.completed, description: @todo_list.description, down_count: @todo_list.down_count, up_count: @todo_list.up_count } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { completed: @todo_list.completed, description: @todo_list.description, down_count: @todo_list.down_count, up_count: @todo_list.up_count } }
